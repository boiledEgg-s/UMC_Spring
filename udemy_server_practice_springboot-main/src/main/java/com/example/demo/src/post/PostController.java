...
public class PostController {
    ...
    @Autowired
    private final com.example.demo.src.post.PostService postService;
    @Autowired
    ...
    public PostController(PostProvider postProvider, com.example.demo.src.post.PostService postService, JwtService jwtService){
