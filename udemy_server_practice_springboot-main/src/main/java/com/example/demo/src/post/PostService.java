...
public class PostService {
    ...
    private final com.example.demo.src.post.PostDao postDao;
    private final com.example.demo.src.post.PostProvider postProvider;
    private final JwtService jwtService;


    @Autowired
    public PostService(com.example.demo.src.post.PostDao postDao, com.example.demo.src.post.PostProvider postProvider, JwtService jwtService) {
