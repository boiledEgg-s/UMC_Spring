...
public class UserController {
    ...
    public BaseResponse<GetUserFeedRes> getUserFeed(@PathVariable("userIdx")int userIdx) {
        try{
            GetUserFeedRes getUserFeedRes = userProvider.getUserFeed(userIdx, userIdx); //jwt 습득 시 비교할 때를 위해 두 개의 파라미터 사용
...
//    }
    ...
    public BaseResponse<DeleteUserRes> deleteUserByIdx(@PathVariable("userIdx") int userIdx) {
        try{
            ...
            DeleteUserRes deleteUsersRes = userService.deleteUser(userIdx);
